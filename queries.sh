...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams INNER JOIN games ON winner_id = team_id ORDER BY name ASC")"

echo -e "\nYear and team name of all the champions:"
echo "$($PSQL "SELECT year, name FROM teams INNER JOIN games ON winner_id = team_id WHERE round = 'Final' ORDER BY year ASC")";
